...
print("Defining LLMs...")
llm_main = ChatOpenRouter(model="moonshotai/kimi-k2-0905", temperature=0)
...
router_llm = ChatOpenRouter(model="moonshotai/kimi-k2-0905", temperature=0)
...
general_llm = ChatOpenRouter(model="moonshotai/kimi-k2-0905", temperature=0)
...
ranking_llm = ChatOpenRouter(model="moonshotai/kimi-k2-0905", temperature=0)
...
reasoning_llm = ChatOpenRouter(model="moonshotai/kimi-k2-0905", temperature=0)
...
reasoning_validator_llm = ChatOpenRouter(model="moonshotai/kimi-k2-0905", temperature=0)
...
prediction_llm = ChatOpenRouter(model="moonshotai/kimi-k2-0905", temperature=0)
